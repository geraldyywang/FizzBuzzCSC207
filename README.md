...
5. In the menu that appears, paste the URL. You can either use the default location on your computer to save the project
   or you can choose the directory. - Note: if you later make another clone of this repository, it will require you to choose a new directory to save it to,
...
but neither of them will _directly_ fix the problem.
...
So far we have only talked about how to _push local changes_ to a remote repository on GitHub. In practice, several
